 ...
 * @author 1013403
 */
public class LuxurySaloon extends Vehicles{
    ...
    public LuxurySaloon(String regno, String manufacturer, String model, int engSize, double cost, int price){
    ...
    public void getDetails(){
        System.out.println();
        System.out.println("The Details for Luxury Saloon\n");
        ...
        System.out.println("The Purchase Price\t\"£" + getPrice() +  "\"");
        if(!(soldOff == 'n')){
    ...
    public void changeDetails()throws IOException{
        ...
        System.out.println("The Purchase Price\t\"£" + getPrice() +  "\"");
        System.out.println("Enter the NEW Purchasde Price: ");
        prc = in.readLine();     
